<%@ Page Title="" Language="C#" MasterPageFile="~/header.Master" AutoEventWireup="true" CodeBehind="xemdiem.aspx.cs" Inherits="GUI.xemdiem1" %>
...
<%--                            <asp:Button ID="bthocbong" runat="server" Text="Xem học bổng" class="btn btn-primary" OnClick="bthocbong_Click" />--%>
                            <asp:Button ID="btxemdiem" runat="server" Text="Xem Điểm"  class="btn btn-primary" OnClick="btxemdiem_Click"  />
                        </div>
    ...
    <div class="row" style="margin-right: 0px; margin-left: 0px; padding-top: 10px">
        ...
        <div class="table table-hover" style="text-align: center">
            <center>
             <asp:GridView ID="dgvxemdiem" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="157px" Width="1169px" style="text-align:center">
